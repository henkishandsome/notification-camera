...
private Uri imageUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picture=findViewById(R.id.pictrue);
        choose_photo=findViewById(R.id.choose_picture);
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    imageUri = FileProvider.getUriForFile(CameraActivity.this,
                            "com.example.app0101.fileprovider",outputImage);
                }else {
        ...
        switch (requestCode) {
            case 1:
                if (grantResults.length >0&&grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this,"permssion deny",Toast.LENGTH_LONG).show();
                }
                break;
            default:
        }
